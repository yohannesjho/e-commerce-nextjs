    ...
    <div className='bg-white px-2 sm:px-8 md:px-16 lg:px-24 py-12 flex flex-col-reverse justify-between  md:flex-row gap-12'>
      <div className='w-96 flex flex-col gap-8'>
        <div className='flex gap-2'>
          ...
          <div>
            ...
            <h1 className='text-xs'>commerce</h1>
          </div>
        </div>
        <h1 className='font-normal text-3xl'>Your Company LLc</h1>
        <p className='font-light'>This website and its contents are provided "as is" and "as available" without any warranty or representations of any kind, whether express or implied. Price and availability information is subject to change without notice.</p>
      </div>
      ...
      <div className='w-96 flex flex-col gap-6'>
        ...
        <div className='flex gap-4'>
          <Link href='' className='hover:bg-slate-400 border-2 rounded-full duration-300'><FaFacebook   className=' p-1 text-4xl text-fuchsia-400 '/></Link>
          <Link href="" className='hover:bg-slate-400 border-2 rounded-full duration-300'><FaInstagram   className='p-1  text-4xl text-fuchsia-400 '/></Link>
          <Link href="" className='hover:bg-slate-400 border-2 rounded-full duration-300'><FaTwitter   className='p-1  text-4xl text-fuchsia-400'/></Link>
        </div>
